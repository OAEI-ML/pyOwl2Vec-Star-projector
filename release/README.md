...
- `core-compatibility.json`: exact pyOWLCore 0.2.1 release commit and public API/model/wire/encoded
  contract for reproducible source-checkout CI, plus the published dependency range and repinned
  fixture fingerprints.
- `owner-release-authorization-0.2.1.md`: version-specific owner authorization for the complete
