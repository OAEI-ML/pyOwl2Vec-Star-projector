...
`EquivalentObjectProperties`, `DisjointObjectProperties`, and `FunctionalObjectProperty` are not
part of the pinned RBox scan at all. Each is counted as a skipped axiom with a grouped
