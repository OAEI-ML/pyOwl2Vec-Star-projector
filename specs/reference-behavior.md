...
`InverseFunctionalObjectProperty` are not part of the pinned RBox scan at all. Each is counted as
a skipped axiom with a grouped `MOWL_SKIPPED_AXIOM` diagnostic and cannot mutate retained role
state.
