...
Kernels v48–v63 add one bounded two-segment `OVERLAY_BASE`/`OVERLAY_DELTA` slice. The base may use
...
`DatatypeDefinition`. The canonical merger derives one insertion scalar without flattening or
