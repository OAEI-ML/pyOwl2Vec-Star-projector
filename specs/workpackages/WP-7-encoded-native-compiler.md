...
Kernels v48–v62 add one bounded two-segment `OVERLAY_BASE`/`OVERLAY_DELTA` slice. The base may use
...
data-range envelope, or a named `FunctionalDataProperty`. The canonical merger derives one
