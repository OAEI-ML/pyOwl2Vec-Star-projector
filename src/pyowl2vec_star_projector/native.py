...
ENCODED_DIRECT_KERNEL_VERSION = 102
    ...
    *,
    ...
    if resolved_aliases is not None:
        ...
        if resolved_delta is not None:
            ...
            if resolved_scope_mapped is None:
                resolved_scope_mapped = (
                    _resolve_private_scope_mapped_object_property_assertion_composite(lease)
                )
            if resolved_scope_mapped is None:
                resolved_scope_mapped = (
                    _resolve_private_scope_mapped_negative_object_property_assertion_composite(
            ...
            if resolved_scope_mapped is None:
                resolved_scope_mapped = (
                    _resolve_private_scope_mapped_data_property_assertion_composite(lease)
                )
            if resolved_scope_mapped is None:
                resolved_scope_mapped = (
                    _resolve_private_scope_mapped_negative_data_property_assertion_composite(
            ...
            if resolved_scope_mapped is None:
                resolved_scope_mapped = (
                    _resolve_private_scope_mapped_same_individual_composite(lease)
                )
            if resolved_scope_mapped is None:
                resolved_scope_mapped = (
            ...
            if resolved_scope_mapped is not None:
                ...
                if resolved_three_member is not None:
                    ...
                    if role_state is not None:
                        return (
                            None,
                            "private native three-member composite slice does not bind "
                            "Scala-instance state",
                        )
                    merge_manifest_lease = lease
                    (
