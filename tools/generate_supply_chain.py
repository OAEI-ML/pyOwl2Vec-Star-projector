...
_RUNTIME_DEPENDENCY = "pyowl-core>=0.2.1,<0.3"
...
def generate(root: Path) -> dict[Path, bytes]:
    ...
    core = _component(
        ...
        properties=[{"name": "pyowl-projector:version-constraint", "value": ">=0.2.1,<0.3"}],
    )
    ...
    license_inventory = {
        ...
        "runtime": [{"name": "pyowl-core", "version": ">=0.2.1,<0.3", "license": "Apache-2.0"}],
